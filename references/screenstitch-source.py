# ScreenStitch - Image Stitcher
# Source: https://github.com/Krocified/ScreenStitch_Image-Stitcher
# Authors: Michael Jong (2101626651), Albertus Heronius (2101690042)
# Requirements: opencv 3.4.2.16 + opencv-contrib 3.4.2.16
#
# Medium article: https://medium.com/@Krocified/screenstitch-an-application-to-stitch-screenshots-a26d67ee5f45
# (Article behind paywall - key insights extracted from source code below)
#
# Core Algorithm:
# 1. Load images from user selection
# 2. Rotate images 90° (for landscape screenshots)
# 3. Use OpenCV's Stitcher class which internally:
#    a. Detects features (SIFT/SURF/ORB)
#    b. Matches features between image pairs
#    c. Estimates homography using RANSAC
#    d. Warps images to a common plane
#    e. Blends seams
# 4. Rotate result back 270°
# 5. Save output
